...
public enum ProductValidationErrors {
    ...
    ProductValidationErrors(String response) {
        this.response = response;
    }

    public static List<ProductValidationErrors> getValidationErrors() {
        return new ArrayList<>(Arrays.asList(ProductValidationErrors.values()));
    }
